...
class bk020306Controller extends Controller
{
	...
	public function Post(Request $request)
	{
		...
		$query='select a.kode,e.nama_depan,e.nama_belakang,d.nama perubahan,b.nama role_lama,c.nama role_baru,f.user_name divalidasi_oleh
			from bkt_02030204_perubahan_status a,bkt_02010102_role b,bkt_02010102_role c,bkt_02010112_jns_perubahan d,bkt_02010111_user e
			left join bkt_02010111_user f on a.divalidasi_oleh=f.id
		...
		if(!empty($posts))
		{
			foreach ($posts as $post)
			{
				...
				$url_approve="/hrm/management/user/penghargaan/approve?kode=".$edit;
				...
				if(!empty($detil['544']) && empty($nestedData['divalidasi_oleh'])){
