	...
	public function post_create(Request $request)
	{
		...
		if ($request->input('kode')!=null){
			...
			->update(['nama' => $request->input('nama-input'),
				...
				'uri_img_sertifikat1' => $request->input('uri_img_sertifikat1-input'),
				'uri_img_sertifikat2' => $request->input('uri_img_sertifikat2-input'),
				'url_img_sertifikat3' => $request->input('url_img_sertifikat3-input'),
