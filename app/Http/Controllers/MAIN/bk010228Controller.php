...
class bk010228Controller extends Controller
{
    /**
    ...
    public function index()
    {
		...
		if(count($akses) > 0){
			...
			if(!empty($data['detil'])){
				...
				$this->log_aktivitas('View', 238);
				return view('MAIN/bk010228/index',$data);
			}
			else {
				return Redirect::to('/');
			}
	...
	public function show()
	{
		...
		return view('/main/persiapan/kelurahan/lembaga/ksm/fasil_bdc',$data);
	}
	...
	public function Post(Request $request)
	{
		...
		if(!empty($posts))
		{
			foreach ($posts as $post)
			{
				...
				$edit =  $post->kode;
				$delete = $post->kode;
				$url_edit=url('/')."/main/persiapan/kelurahan/lembaga/ksm/fasil_bdc/create?kode=".$show;
				$url_delete=url('/')."/main/persiapan/kelurahan/lembaga/ksm/fasil_bdc/delete?kode=".$delete;
	...
	public function create(Request $request)
	{
		...
		if($data['kode']!=null && !empty($data['detil']['240'])){
			...
			return view('MAIN/bk010228/create',$data);
		}else if($data['kode']==null && !empty($data['detil']['239'])){
			$data['tahun'] = null;
			$data['kode_kota'] = null;
	...
	public function delete(Request $request)
	{
        ...
        $this->log_aktivitas('Delete', 241);
        return Redirect::to('/main/persiapan/kelurahan/lembaga/ksm/fasil_bdc');
    }
