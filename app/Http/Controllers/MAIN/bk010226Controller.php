...
class bk010226Controller extends Controller
{
    /**
    ...
    public function index()
    {
		...
		if(count($akses) > 0){
			...
			if(!empty($data['detil'])){
				...
				$this->log_aktivitas('View', 230);
				return view('MAIN/bk010226/index',$data);
			}
			else {
				return Redirect::to('/');
			}
	...
	public function show()
	{
		...
		return view('/main/persiapan/kelurahan/lembaga/ksm/ppmk',$data);
	}
	...
	public function Post(Request $request)
	{
		...
		if(!empty($posts))
		{
			foreach ($posts as $post)
			{
				...
				$edit =  $post->kode;
				$delete = $post->kode;
				$url_edit=url('/')."/main/persiapan/kelurahan/lembaga/ksm/ppmk/create?kode=".$show;
				$url_delete=url('/')."/main/persiapan/kelurahan/lembaga/ksm/ppmk/delete?kode=".$delete;
	...
	public function create(Request $request)
	{
		...
		if($data['kode']!=null && !empty($data['detil']['232'])){
			...
			return view('MAIN/bk010226/create',$data);
		}else if($data['kode']==null && !empty($data['detil']['231'])){
			$data['tahun'] = null;
			$data['kode_kota'] = null;
	...
	public function delete(Request $request)
	{
        ...
        $this->log_aktivitas('Delete', 233);
        return Redirect::to('/main/persiapan/kelurahan/lembaga/ksm/ppmk');
    }
