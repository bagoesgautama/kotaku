...
class bk010302Controller extends Controller
{
	...
	public function Post(Request $request)
	{
		...
		if(!empty($posts))
		{
			foreach ($posts as $post)
			{
				...
				$delete = $post->kode;
				//show
				$url_show=url('/')."/main/perencanaan/penanganan/pelaksanaan_rpk/create?kode=".$edit."&show=true";
	...
	public function show(Request $request)
	{
		...
		if(count($akses) > 0){
			...
			if($data['kode']!=null  && !empty($data['detil']['257'])){
