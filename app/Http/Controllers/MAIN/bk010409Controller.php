...
class bk010409Controller extends Controller
{
    /**
	...
	public function Post(Request $request)
	{
		...
		if(!empty($posts))
		{
			foreach ($posts as $post)
			{
				...
				$url_edit=url('/')."/main/pelaksanaan/kelurahan/sertifikasi_infra/create?kode=".$edit;
				$url_delete=url('/')."/main/pelaksanaan/kelurahan/sertifikasi_infra/delete?kode=".$delete;
