...
class bk010229Controller extends Controller
{
    /**
    ...
    public function index()
    {
		...
		if(count($akses) > 0){
			...
			if(!empty($data['detil'])){
				...
				$this->log_aktivitas('View', 242);
				return view('MAIN/bk010229/index',$data);
			}
			else {
				return Redirect::to('/');
			}
	...
	public function show()
	{
		...
		return view('/main/persiapan/kelurahan/lembaga/ksm/tabungan',$data);
	}
	...
	public function create(Request $request)
	{
		...
		if($data['kode']!=null && !empty($data['detil']['244'])){
			...
			return view('MAIN/bk010229/create',$data);
		}else if($data['kode']==null && !empty($data['detil']['243'])){
			$data['tahun'] = null;
			$data['kode_kota'] = null;
	...
	public function delete(Request $request)
	{
        ...
        $this->log_aktivitas('Delete', 245);
        return Redirect::to('/main/persiapan/kelurahan/lembaga/ksm/tabungan');
    }
