...
class bk010227Controller extends Controller
{
    /**
    ...
    public function index()
    {
		...
		if(count($akses) > 0){
			...
			if(!empty($data['detil'])){
				...
				$this->log_aktivitas('View', 234);
				return view('MAIN/bk010227/index',$data);
			}
			else {
				return Redirect::to('/');
			}
	...
	public function show()
	{
		...
		return view('/main/persiapan/kelurahan/lembaga/ksm/syariah',$data);
	}
	...
	public function Post(Request $request)
	{
		...
		if(!empty($posts))
		{
			foreach ($posts as $post)
			{
				...
				$edit =  $post->kode;
				$delete = $post->kode;
				$url_edit=url('/')."/main/persiapan/kelurahan/lembaga/ksm/syariah/create?kode=".$show;
				$url_delete=url('/')."/main/persiapan/kelurahan/lembaga/ksm/syariah/delete?kode=".$delete;
	...
	public function create(Request $request)
	{
		...
		if($data['kode']!=null && !empty($data['detil']['236'])){
			...
			return view('MAIN/bk010227/create',$data);
		}else if($data['kode']==null && !empty($data['detil']['235'])){
			$data['tahun'] = null;
			$data['kode_kota'] = null;
	...
	public function delete(Request $request)
	{
        ...
        $this->log_aktivitas('Delete', 237);
        return Redirect::to('/main/persiapan/kelurahan/lembaga/ksm/syariah');
    }
