...
class bk010313Controller extends Controller
{
	...
	public function post_create(Request $request)
	{
		if ($request->input('kode')!=null){
			...
			->update(['lpt_l_hibah_gov' => $request->input('lpt_l_hibah_gov-input'),
				'lpt_l_hibah_masy' => $request->input('lpt_l_hibah_masy-input'),
				'lpt_l_hibah_lain' => $request->input('lpt_l_hibah_lain-input'),
				'lpt_l_ijin_pakai_gov' => $request->input('lpt_l_ijin_pakai_gov-input'),
				'lpt_l_ijin_pakai_masy' => $request->input('lpt_l_ijin_pakai_masy-input'),
				'lpt_l_ijin_pakai_lain' => $request->input('lpt_l_ijin_pakai_lain-input'),
				'lpt_l_dilalui_gov' => $request->input('lpt_l_dilalui_gov-input'),
				'lpt_l_dilalui_masy' => $request->input('lpt_l_dilalui_masy-input'),
				'lpt_l_dilalui_lain' => $request->input('lpt_l_dilalui_lain-input'),
				'lpt_rp_nilai_gov' => $request->input('lpt_rp_nilai_gov-input'),
				'lpt_rp_nilai_masy' => $request->input('lpt_rp_nilai_masy-input'),
				'lpt_rp_nilai_lain' => $request->input('lpt_rp_nilai_lain-input'),
				'lpt_q_pt_kk_hibah' => $request->input('lpt_q_pt_kk_hibah-input'),
				'lpt_q_pt_kk_ijin_pakai' => $request->input('lpt_q_pt_kk_ijin_pakai-input'),
				'lpt_q_pt_kk_ijin_dilalui' => $request->input('lpt_q_pt_kk_ijin_dilalui-input'),
				'kl_lt_pre' => $request->input('kl_lt_pre-input'),
				'kl_lt_pos' => $request->input('kl_lt_pos-input'),
				'kl_q_peserta' => $request->input('kl_q_peserta-input'),
				'kl_q_peserta_w' => $request->input('kl_q_peserta_w-input'),
				'pk_lt_pre' => $request->input('pk_lt_pre-input'),
				'pk_lt_pos' => $request->input('pk_lt_pos-input'),
				'pk_q_peserta' => $request->input('pk_q_peserta-input'),
				'pk_q_peserta_w' => $request->input('pk_q_peserta_w-input'),
				'mha_q_jiwa' => $request->input('mha_q_jiwa-input'),
				'mha_q_jiwa_w' => $request->input('mha_q_jiwa_w-input'),
				'mha_q_wtp' => $request->input('mha_q_wtp-input'),
				'mha_q_wtp_w' => $request->input('mha_q_wtp_w-input'),
				'mha_q_wpm' => $request->input('mha_q_wpm-input'),
				'mha_q_wpm_w' => $request->input('mha_q_wpm_w-input'),
				'mha_flag_rk_mha' => $request->input('mha_flag_rk_mha-input'),
				'dl_flag_ukl_upl' => $request->input('dl_flag_ukl_upl-input'),
				'dl_flag_sop' => $request->input('dl_flag_sop-input'),
				'cb_flag_di_kaw_cb' => $request->input('cb_flag_di_kaw_cb-input'),
				'cb_flag_sop' => $request->input('cb_flag_sop-input'),
				'rb_flag_di_kaw_rb' => $request->input('rb_flag_di_kaw_rb-input'),
				'dl_flag_sop' => $request->input('dl_flag_sop-input'),
				'pk_flag_pakai_kayu' => $request->input('pk_flag_pakai_kayu-input'),
				'pk_vol_kayu' => $request->input('pk_vol_kayu-input'),
				'lk_flag_legal_kayu' => $request->input('lk_flag_legal_kayu-input'),
				'lk_vol_kayu_legal' => $request->input('lk_vol_kayu_legal-input'),
				'uri_img_document' => $request->input('uri_img_document-input-input'),
			...
			DB::table('bkt_01030209_pkt_krj_kontraktor')->insert([
				'lpt_l_hibah_gov' => $request->input('lpt_l_hibah_gov-input'),
				'lpt_l_hibah_masy' => $request->input('lpt_l_hibah_masy-input'),
				'lpt_l_hibah_lain' => $request->input('lpt_l_hibah_lain-input'),
				'lpt_l_ijin_pakai_gov' => $request->input('lpt_l_ijin_pakai_gov-input'),
				'lpt_l_ijin_pakai_masy' => $request->input('lpt_l_ijin_pakai_masy-input'),
