	...
	public function Post(Request $request)
	{
		...
		if(!empty($posts))
		{
			foreach ($posts as $post)
			{
				...
				$edit =  $post->kode;
				$delete = $post->kode;
				$url_edit="/main/persiapan/kelurahan/lembaga/organisasi_pengelola/create?kode=".$show;
				$url_delete="/main/persiapan/kelurahan/lembaga/organisasi_pengelola/delete?kode=".$delete;
