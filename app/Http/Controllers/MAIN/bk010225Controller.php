...
class bk010225Controller extends Controller
{
    /**
	...
	public function show()
	{
		...
		return view('/main/persiapan/kelurahan/lembaga/organisasi_pengelola',$data);
	}
	...
	public function Post(Request $request)
	{
		...
		if(!empty($posts))
		{
			foreach ($posts as $post)
			{
				...
				$edit =  $post->kode;
				$delete = $post->kode;
				$url_edit=url('/')."/main/persiapan/kelurahan/lembaga/organisasi_pengelola/create?kode=".$show;
				$url_delete=url('/')."/main/persiapan/kelurahan/lembaga/organisasi_pengelola/delete?kode=".$delete;
	...
	public function create(Request $request)
	{
		...
		if($data['kode']!=null && !empty($data['detil']['216'])){
		...
		}else if($data['kode']==null && !empty($data['detil']['215'])){
			$data['tahun'] = null;
			$data['kode_kota'] = null;
	...
	public function delete(Request $request)
	{
        ...
        $this->log_aktivitas('Delete', 217);
        return Redirect::to('/main/persiapan/kelurahan/lembaga/organisasi_pengelola');
    }
