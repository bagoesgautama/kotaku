...
class bk010210Controller extends Controller
{
	...
	public function Post(Request $request)
	{
		...
		$query='select a.kode, a.tahun, b.nama as kode_kota, d.nama as kode_kmw, e.nama as kode_korkot, a.jenis_kegiatan, a.tgl_kegiatan, a.lok_kegiatan, a.created_time from bkt_01020208_kolab_kota a, bkt_01010102_kota b, bkt_01010110_kmw d, bkt_01010111_korkot e where a.kode_kota = b.kode and a.kode_kmw = d.kode and a.kode_korkot = e.kode and a.tk_forum = 1';
		$totalData = DB::select('select count(1) cnt from bkt_01020208_kolab_kota a, bkt_01010102_kota b, bkt_01010110_kmw d, bkt_01010111_korkot e where a.kode_kota = b.kode and a.kode_kmw = d.kode and a.kode_korkot = e.kode and a.tk_forum = 1');
	...
	public function post_create(Request $request)
	{
		...
		if ($request->input('kode')!=null){
			...
			if($upload_absensi == true){
				$file_absensi->move(public_path('/uploads/persiapan/kota/forum/kolaborasi'), $file_absensi->getClientOriginalName());
			}
