	...
	public function Post(Request $request)
	{
		...
		if(!empty($posts))
		{
			foreach ($posts as $post)
			{
				...
				$edit =  $post->kode;
				$delete = $post->kode;
				$url_edit=url('/')."/main/persiapan/kota/kegiatan/relawan/create?kode=".$edit;
				$url_delete=url('/')."/main/persiapan/kota/kegiatan/relawan/delete?kode=".$delete;
	...
	public function post_create(Request $request)
	{
		...
		if ($request->input('kode')!=null){
			...
			if($upload_dokumen == true){
				$file_dokumen->move(public_path('/uploads/persiapan/kota/kegiatan/relawan'), $file_dokumen->getClientOriginalName());
			}
