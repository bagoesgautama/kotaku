        ...
        <ul class="breadcrumb">
			...
			<li class="next">
				<a href="/hrm/management_personil/persetujuan/mutasi">
	                Managemen Personil / Persetujuan / Mutasi
				</a>
            </li>
            <li class="next">
                Create
						...
						<form id="form" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-9 col-sm-offset-3">
                                    <a href="/hrm/pmanagement_personil/persetujuan/mutasi" type="button" class="btn btn-effect-ripple btn-danger">
                                        Cancel
                                    </a>
...
<script>
  ...
  $(document).ready(function () {
    $('#approve').on('click', function (e) {
		...
		$.ajax({
			type: 'post',
			"url": "/hrm/management_personil/persetujuan/mutasi/approve",
			data: {kode:kode},
			beforeSend: function (){
			...
			success: function () {
				...
				window.location.href = "/hrm/management_personil/persetujuan/mutasi";
			},
    ...
    $('#reject').on('click', function (e) {
		...
		$.ajax({
			type: 'post',
			"url": "/hrm/management_personil/persetujuan/mutasi/reject",
			data: {kode:kode},
			beforeSend: function (){
