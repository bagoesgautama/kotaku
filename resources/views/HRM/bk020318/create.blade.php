@extends('HRM/default') {{-- Page title --}} @section('title') Persetujuan Demosi Form @stop {{-- local styles --}} @section('header_styles')
        ...
        <ul class="breadcrumb">
			...
			<li class="next">
				<a href="/hrm/management_personil/persetujuan/demosi">
	                Managemen Personil / Persetujuan / Demosi
				</a>
            </li>
            <li class="next">
                Create
                    ...
                    <div class="col-md-12">
						<form id="form" enctype="multipart/form-data" class="form-horizontal form-bordered">
							...
							<div class="form-group striped-col">
				                ...
				                <div class="col-sm-6">
									<select id="kode_jns_perubahan-input" name="kode_jns_perubahan-input" class="form-control" size="1" disabled>
							...
							<div class="form-group striped-col">
				                ...
				                <div class="col-sm-6">
									<select id="kode_role_baru-input" name="kode_role_baru-input" class="form-control" size="1" disabled>
										<option value>Please Select</option>
										@foreach ($role as $kpl)
							...
							<div class="form-group ">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" id="tgl_efektif_role_baru-input" name="tgl_efektif_role_baru-input" placeholder="Tanggal Penghargaan" data-provide="datepicker" data-date-format="yyyy-mm-dd" value="{{$tgl_efektif_role_baru}}" disabled>
                                </div>
                            </div>
							<div class="form-group striped-col">
							...
							<div class="form-group ">
				                ...
				                <div class="col-sm-6">
									<select id="kode_prop_baru-input" name="kode_prop_baru-input" class="form-control" size="1" disabled>
										<option value>Please select</option>
				                        @foreach ($prop_list as $kkl)
				            ...
				            <div class="form-group striped-col">
				                ...
				                <div class="col-sm-6">
									<select id="kode_kota_baru-input" name="kode_kota_baru-input" class="form-control" size="1" disabled>
										<option value>Please select</option>
				            ...
				            <div class="form-group ">
				                ...
				                <div class="col-sm-6">
									<select id="kode_kel_baru-input" name="kode_kel_baru-input" class="form-control" size="1" disabled>
										<option value>Please select</option>
							...
							<div class="form-group striped-col">
				                ...
				                <div class="col-sm-6">
				                    <textarea id="catatan-input" name="catatan-input" class="form-control" disabled>{{$catatan}}</textarea>
				                </div>
				            </div>
				            @if ($kode_user!=$id)
				            <div class="form-group striped-col">
				                ...
				                <div class="col-sm-6">
				                    <textarea id="catatan-val-input" name="catatan-val-input" class="form-control" disabled>{{$catatan_validasi}}</textarea>
				                </div>
				            </div>
				            @endif
							<div class="form-group ">
				                ...
				                <div class="col-sm-6">
									<input id="uri_img_sk1-input" type="file" class="file" accept="image/*" name="uri_img_sk1-input" disabled>
				                    <br>
							...
							<div class="form-group striped-col">
				                ...
				                <div class="col-sm-6">
				                    <input id="uri_img_sk2-input" type="file" class="file" accept="image/*" name="uri_img_sk2-input" disabled>
				                    <br>
							...
							<div class="form-group ">
				                ...
				                <div class="col-sm-6">
				                    <input id="uri_img_sk3-input" type="file" class="file" accept="image/*" name="uri_img_sk3-input" disabled>
				                    <br>
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-9 col-sm-offset-3">
                                    <a href="/hrm/pmanagement_personil/persetujuan/demosi" type="button" class="btn btn-effect-ripple btn-danger">
                                        Cancel
                                    </a>
...
<script>
  ...
  $(document).ready(function () {
    $('#approve').on('click', function (e) {
		...
		$.ajax({
			type: 'post',
			"url": "/hrm/management_personil/persetujuan/demosi/approve",
			data: {kode:kode},
			beforeSend: function (){
			...
			success: function () {
				...
				window.location.href = "/hrm/management_personil/persetujuan/demosi";
			},
    ...
    $('#reject').on('click', function (e) {
		...
		$.ajax({
			type: 'post',
			"url": "/hrm/management_personil/persetujuan/demosi/reject",
			data: {kode:kode},
			beforeSend: function (){
