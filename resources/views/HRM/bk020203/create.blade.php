@extends('HRM/default') {{-- Page title --}} @section('title') Demosi Form @stop {{-- local styles --}} @section('header_styles')
                ...
                <div class="row">
                    <div class="col-md-12">
						<form id="form" enctype="multipart/form-data" class="form-horizontal form-bordered">
							...
							<div class="form-group ">
                                <label class="col-sm-3 control-label" for="example-text-input1">Tanggal Demosi</label>
                                <div class="col-sm-6">
                                    <input class="form-control" id="tgl_efektif_role_baru-input" name="tgl_efektif_role_baru-input" placeholder="Tanggal Demosi" data-provide="datepicker" data-date-format="yyyy-mm-dd" value="{{$tgl_efektif_role_baru}}" required>
                                </div>
                            </div>
							<div class="form-group striped-col">
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-9 col-sm-offset-3">
                                    <a href="/hrm/management_diri/demosi" type="button" class="btn btn-effect-ripple btn-danger">
                                        Cancel
                                    </a>
  ...
  $(document).ready(function () {
	$('#form').on('submit', function (e) {
		...
		$.ajax({
			...
			processData: false,
            contentType: false,
			"url": "/hrm/management_diri/demosi/create",
			data: form_data,
			beforeSend: function (){
			...
			success: function () {
				...
				window.location.href = "/hrm/management_diri/demosi";
			},
