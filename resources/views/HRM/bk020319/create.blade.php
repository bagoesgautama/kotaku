@extends('HRM/default') {{-- Page title --}} @section('title') Persetujuan Promosi Form @stop {{-- local styles --}} @section('header_styles')
						...
						<form id="form" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-9 col-sm-offset-3">
                                    <a href="/hrm/pmanagement_personil/persetujuan/promosi" type="button" class="btn btn-effect-ripple btn-danger">
                                        Cancel
                                    </a>
...
<script>
  ...
  $(document).ready(function () {
    $('#approve').on('click', function (e) {
		...
		$.ajax({
			type: 'post',
			"url": "/hrm/management_personil/persetujuan/promosi/approve",
			data: {kode:kode},
			beforeSend: function (){
			...
			success: function () {
				...
				window.location.href = "/hrm/management_personil/persetujuan/promosi";
			},
    ...
    $('#reject').on('click', function (e) {
		...
		$.ajax({
			type: 'post',
			"url": "/hrm/management_personil/persetujuan/promosi/reject",
			data: {kode:kode},
			beforeSend: function (){
