@extends('HRM/default') {{-- Page title --}} @section('title') Demosi Personil Form @stop {{-- local styles --}} @section('header_styles')
        ...
        <ul class="breadcrumb">
			...
			<li class="next">
				<a href="/hrm/management_personil/demosi">
	                Managemen Personil / Mengatur Demosi Personil
				</a>
            </li>
            <li class="next">
                Create
						...
						<form id="form" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-9 col-sm-offset-3">
                                    <a href="/hrm/management_personil/demosi" type="button" class="btn btn-effect-ripple btn-danger">
                                        Cancel
                                    </a>
  ...
  $(document).ready(function () {
	...
	$('#form').on('submit', function (e) {
		...
		$.ajax({
			...
			processData: false,
            contentType: false,
			"url": "/hrm/management_personil/demosi/create",
			data: form_data,
			beforeSend: function (){
			...
			success: function () {
				...
				window.location.href = "/hrm/management_personil/demosi";
			},
    ...
    $('#approve').on('click', function (e) {
		...
		$.ajax({
			type: 'post',
			"url": "/hrm/management_personil/demosi/approve",
			data: {kode:kode},
			beforeSend: function (){
    ...
    $('#reject').on('click', function (e) {
		...
		$.ajax({
			type: 'post',
			"url": "/hrm/management_personil/demosi/reject",
			data: {kode:kode},
			beforeSend: function (){
