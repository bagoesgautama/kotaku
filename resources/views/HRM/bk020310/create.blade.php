@extends('HRM/default') {{-- Page title --}} @section('title') Kuota KMW Form @stop {{-- local styles --}} @section('header_styles')
                    ...
                    <div class="col-md-12">
						<form id="form" enctype="multipart/form-data" class="form-horizontal form-bordered">
							...
							<div class="form-group striped-col">
				                ...
				                <div class="col-sm-6">
									<select id="kode_kmw-input" name="kode_kmw-input" class="form-control" size="1" required>
										<option value>Please Select</option>
										@foreach ($kmw_list as $kpl)
