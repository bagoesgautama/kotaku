@extends('HRM/default') {{-- Page title --}} @section('title') Mutasi Form @stop {{-- local styles --}} @section('header_styles')
  ...
  $(document).ready(function () {
	$('#form').on('submit', function (e) {
		...
		$.ajax({
			...
			processData: false,
            contentType: false,
			"url": "/hrm/management_diri/mutasi/create",
			data: form_data,
			beforeSend: function (){
			...
			success: function () {
				...
				window.location.href = "/hrm/management_diri/mutasi";
			},
