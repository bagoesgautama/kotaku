@extends('HRM/default') {{-- Page title --}} @section('title') Promosi Personil Form @stop {{-- local styles --}} @section('header_styles')
        ...
        <ul class="breadcrumb">
			...
			<li class="next">
				<a href="/hrm/management_personil/promosi">
	                Managemen Personil / Mengatur Promosi Personil
				</a>
            </li>
            <li class="next">
                Create
						...
						<form id="form" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-9 col-sm-offset-3">
                                    <a href="/hrm/management_personil/Promosi" type="button" class="btn btn-effect-ripple btn-danger">
                                        Cancel
                                    </a>
  ...
  $(document).ready(function () {
	...
	$('#form').on('submit', function (e) {
		...
		$.ajax({
			...
			processData: false,
            contentType: false,
			"url": "/hrm/management_personil/promosi/create",
			data: form_data,
			beforeSend: function (){
			...
			success: function () {
				...
				window.location.href = "/hrm/management_personil/promosi";
			},
    ...
    $('#approve').on('click', function (e) {
		...
		$.ajax({
			type: 'post',
			"url": "/hrm/management_personil/promosi/approve",
			data: {kode:kode},
			beforeSend: function (){
    ...
    $('#reject').on('click', function (e) {
		...
		$.ajax({
			type: 'post',
			"url": "/hrm/management_personil/promosi/reject",
			data: {kode:kode},
			beforeSend: function (){
