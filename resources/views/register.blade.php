            ...
            <div class="panel-body">
                <div class="row">
                    <form action="/registrasi" id="authentication" method="post" class="signup_validator">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-12" id="info_bank" hidden>
                                <p class="form-group">
                                    Informasi Bank
                                </p>
                            </div>
                            ...
                            <div class="col-md-12" id="kec_label" hidden>
                                <div class="form-group">
                                    ...
                                    <select id="select-kode-kec-input" name="kode-kec-input" class="form-control select2" size="1">
                                        <option value>WK Kecamatan</option>
                                    </select>
                                </div>
                            </div>
...
<script>
    $(document).ready(function () {
        ...
        wkkota.change(function(){
            ...
            if(wkkota_id!=null){
                wkkec.empty();
                wkkec.append("<option value>WK Kecamatan</option>");
                $.ajax({
                    type: 'get',
        ...
        wkkec.change(function(){
            ...
            if(wkkec_id!=null){
                wkkel.empty();
                wkkel.append("<option value>WK Kelurahan</option>");
                $.ajax({
                    type: 'get',
