      ...
      $(document).ready(function () {
        ...
        prop.change(function(){
            ...
            if(prop_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/info/select?prop="+prop_id,
        ...
        kmw.change(function(){
            ...
            if(kmw_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/info/select?kmw="+kmw_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
        ...
        kota.change(function(){
            ...
            if(kota_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/info/select?kota_korkot="+kota_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
        ...
        kota.change(function(){
            ...
            if(kota_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/info/select?kota_kec="+kota_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
        ...
        kec.change(function(){
            ...
            if(kec_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/info/select?kec_kel="+kec_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
        ...
        kel.change(function(){
            ...
            if(kel_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/info/select?kel_faskel="+kel_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
