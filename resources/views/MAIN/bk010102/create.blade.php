        ...
        <div class="row">
            ...
            <div class="form-group form-actions">
                <div class="col-sm-9 col-sm-offset-3">
                    <a href="/main/data_wilayah/kota" type="button" class="btn btn-effect-ripple btn-danger">
                        Cancel
                    </a>
      ...
      $(document).ready(function () {
        $('#submit').on('click', function (e) {
          ...
          $.ajax({
            ...
            processData: false,
            contentType: false,
            "url": "/main/data_wilayah/kota/create",
            data: form_data,
            beforeSend: function (){
            ...
            window.location.href = "/main/data_wilayah/kota";
            },
