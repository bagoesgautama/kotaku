                    ...
                    <div class="col-md-12">
                        <form id="form-validation" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group striped-col">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" id="tgl-kegiatan-input" name="tgl-kegiatan-input" placeholder="Klik Untuk Pilih Tanggal" data-provide="datepicker" data-date-format="yyyy-mm-dd" value="{{$tgl_kegiatan}}" required data-bv-callback="true" data-bv-callback-message="Tanggal melebihi current date." data-bv-callback-callback="tgl">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group striped-col">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" id="upp-kementrian-input" name="upp-kementrian-input" class="form-control" placeholder="Jumlah" value="{{$upp_kl}}" maxlength="11" data-bv-callback="true" data-bv-callback-message="Jumlah melebihi total anggota laki-laki & perempuan" data-bv-callback-callback="check" min="0">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="kode">Dinas/Badan</label>
                                <div class="col-sm-6">
                                    <input type="number" id="upp-dinas-input" name="upp-dinas-input" class="form-control" placeholder="Jumlah" value="{{$upp_dinas}}" maxlength="11" data-bv-callback="true" data-bv-callback-message="Jumlah melebihi total anggota laki-laki & perempuan" data-bv-callback-callback="check" min="0">
                                </div>
                            </div>
                            <div class="form-group striped-col">
                                <label class="col-sm-3 control-label" for="kode">DPR/DPD Pusat/DPRD</label>
                                <div class="col-sm-6">
                                    <input type="number" id="upp-dpr-input" name="upp-dpr-input" class="form-control" placeholder="Jumlah" value="{{$upp_dpr}}" maxlength="11" data-bv-callback="true" data-bv-callback-message="Jumlah melebihi total anggota laki-laki & perempuan" data-bv-callback-callback="check" min="0">
                                </div>
                            </div>
							<div class="form-group">
                            ...
                            <div class="form-group striped-col">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" id="upnp-lsm-input" name="upnp-lsm-input" class="form-control" placeholder="Jumlah" value="{{$upn_lsm}}" maxlength="11" data-bv-callback="true" data-bv-callback-message="Jumlah melebihi total anggota laki-laki & perempuan" data-bv-callback-callback="check" min="0">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="kode">Swasta/Badan Usaha</label>
                                <div class="col-sm-6">
                                    <input type="number" id="upnp-swasta-input" name="upnp-swasta-input" class="form-control" placeholder="Jumlah" value="{{$unp_bu}}" maxlength="11" data-bv-callback="true" data-bv-callback-message="Jumlah melebihi total anggota laki-laki & perempuan" data-bv-callback-callback="check" min="0">
                                </div>
                            </div>
                            <div class="form-group striped-col">
                                <label class="col-sm-3 control-label" for="kode">Praktisi/Profesional/Perguruan Tinggi</label>
                                <div class="col-sm-6">
                                    <input type="number" id="upnp-praktisi-input" name="upnp-praktisi-input" class="form-control" placeholder="Jumlah" value="{{$upn_praktisi}}" maxlength="11" data-bv-callback="true" data-bv-callback-message="Jumlah melebihi total anggota laki-laki & perempuan" data-bv-callback-callback="check" min="0">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group striped-col">
                                ...
                                <div class="col-sm-6">
                                    <textarea id="ket-rencana-kerja-input" name="ket-rencana-kerja-input" rows="7" class="form-control resize_vertical" placeholder="Keterangan Rencana Kerja" maxlength="50" required>{{ $ket_rencana_kerja }}</textarea>
                                </div>
                            </div>
							<div class="form-group">
