        ...
        <div class="row">
            <div class="form-group striped-col">
                ...
                <input type="hidden" id="example-text-input1" name="example-id-input" value="{{ $kode }}">
                    <input type="text" id="example-text-input1" name="example-no_urut-input" class="form-control" placeholder="No Urut" value="{{ $nourut }}" maxlength="4">
                </div>
            </div>
            ...
            <div class="form-group striped-col">
                ...
                <div class="col-sm-6">
                    <textarea id="example-textarea-input2" name="example-keterangan-input" rows="7" class="form-control resize_vertical" placeholder="Keterangan" maxlength="300">{{ $keterangan }}</textarea>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <input id="email" type="email" class="form-control  form-control-lg" name="example-email1" value="{{ $email1}}" placeholder="E-mail" required maxlength="255">
            ...
            <div class="form-group striped-col">
                ...
                <div class="col-sm-6">
                    ...
                    <input id="email" type="email" class="form-control  form-control-lg" name="example-email2" value="{{ $email2 }}" placeholder="E-mail" required maxlength="255">
            ...
            <div class="form-group striped-col">
                ...
                <div class="col-sm-6">
                    <textarea id="example-textarea-input2" name="example-pms_alamat-input" rows="7" class="form-control resize_vertical" placeholder="Alamat PMS" maxlength="100">{{ $pms_alamat }}</textarea>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group striped-col">
                ...
                <div class="col-sm-6">
                    <input type="text" id="example-text-input1" name="example-tahun_apbd1-input" class="form-control" placeholder="APBD 1" value="{{ $tahun_apbd1 }}" maxlength="4">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label" for="example-text-input1">Tahun APBD 2</label>
                <div class="col-sm-6">
                    <input type="text" id="example-text-input1" name="example-tahun_apbd2-input" class="form-control" placeholder="APBD 2" value="{{ $tahun_apbd2 }}" maxlength="4">
                </div>
            </div>
            <div class="form-group striped-col">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" id="example-text-input1" name="example-glosary_caption-input" class="form-control" placeholder="Glosary Caption" value="{{ $glosary_caption }}" maxlength="50">
                </div>
            </div>
            <div class="form-group striped-col">
