@extends('MAIN/default') {{-- Page title --}} @section('title') Pemeliharaan & Keberlanjutan Form @stop {{-- local styles --}} @section('header_styles')
        ...
        <ul class="breadcrumb">
            ...
            <li class="next">
                <a href="/main/keberlanjutan/kelurahan/pemeliharaan">
                    Keberlanjutan / Skala Kelurahan / Pemeliharaan & Keberlanjutan
                </a>
            </li>
            <li class="next">
                Create
                ...
                <div class="tab-content">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select id="select-kode-parent-input" name="kode-parent-input" class="form-control select2" size="1" required>
                                                ...
                                                @foreach ($kode_parent_list as $kpl)
                                                    <option value="{{$kpl->kode}}" {!! $kode_real_keg==$kpl->kode ? 'selected':'' !!}>{{$kpl->jenis_komponen_keg.$kpl->usulan_komponen.'-'.$kpl->nama_subkomponen.'-'.$kpl->nama_dtl_subkomponen.'-'.$kpl->nama_kota.'-'.$kpl->nama_kawasan.'-'.$kpl->nama_kel}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="form-group form-actions">
                        <div class="col-sm-9 col-sm-offset-3">
                            <a href="/main/keberlanjutan/kelurahan/pemeliharaan" type="button" class="btn btn-effect-ripple btn-danger">
                                Cancel
                            </a>
      ...
      $(document).ready(function () {
        ...
        $('#form').on('submit', function (e) {
          ...
          $.ajax({
            ...
            processData: false,
            contentType: false,
            "url": "/main/keberlanjutan/kelurahan/pemeliharaan/create",
            data: form_data,
            beforeSend: function (){
            ...
            window.location.href = "/main/keberlanjutan/kelurahan/pemeliharaan";
            },
        ...
        parent.change(function(){
            ...
            if(parent_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/keberlanjutan/kelurahan/pemeliharaan/select?kode_parent="+parent_id,
