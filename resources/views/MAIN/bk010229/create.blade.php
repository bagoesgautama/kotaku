...
<section class="content-header">
    <h1>Persiapan Kelurahan - KSM Memiliki Tabungan di Lembaga Keuangan Resmi </h1>
                        ...
                        <form enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-9 col-sm-offset-3">
                                    <a href="/main/persiapan/kelurahan/lembaga/ksm/tabungan" type="button" class="btn btn-effect-ripple btn-danger">
                                        Cancel
                                    </a>
...
<script>
      $(document).ready(function () {
        ...
        $.ajax({
            type: 'post',
            "url": "/main/persiapan/kelurahan/lembaga/ksm/tabungan/create",
            data: $('form').serialize(),
            beforeSend: function (){
