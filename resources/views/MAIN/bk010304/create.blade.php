@extends('MAIN/default') {{-- Page title --}} @section('title') Konsultasi Perencanaan Form @stop {{-- local styles --}} @section('header_styles')
        ...
        <ul class="breadcrumb">
            ...
            <li class="next">
                <a href="/main/perencanaan/penanganan/konsultasi_perencanaan">
                    Perencanaan / Penanganan Pemukiman Kota / Konsultasi Perencanaan
                </a>
            </li>
            <li class="next">
                Create
                        ...
                        <form id="form" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-9 col-sm-offset-3">
                                    <a href="/main/perencanaan/penanganan/konsultasi_perencanaan" type="button" class="btn btn-effect-ripple btn-danger">
                                        Cancel
                                    </a>
                                    @if ($detil_menu=='267' || $detil_menu=='268')
      ...
      $(document).ready(function () {
        ...
        $('#form').on('submit', function (e) {
          ...
          $.ajax({
            ...
            processData: false,
            contentType: false,
            "url": "/main/perencanaan/penanganan/konsultasi_perencanaan/create",
            data: form_data,
            beforeSend: function (){
            ...
            window.location.href = "/main/perencanaan/penanganan/konsultasi_perencanaan";
            },
        ...
        kmw.change(function(){
            ...
            if(kmw_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/perencanaan/penanganan/konsultasi_perencanaan/select?kmw="+kmw_id,
        ...
        kota.change(function(){
            ...
            if(kota_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/perencanaan/penanganan/konsultasi_perencanaan/select?kota_korkot="+kota_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
