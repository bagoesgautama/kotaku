@extends('MAIN/default') {{-- Page title --}} @section('title') Lokakarya Perencanaan Form @stop {{-- local styles --}} @section('header_styles')
      ...
      $(document).ready(function () {
        $('#form').on('submit', function (e) {
          ...
          $.ajax({
            ...
            processData: false,
            contentType: false,
            "url": "/main/perencanaan/penanganan/lokakarya_perencanaan/create",
            data: form_data,
            beforeSend: function (){
            ...
            window.location.href = "/main/perencanaan/penanganan/lokakarya_perencanaan";
            },
        ...
        kmw.change(function(){
            ...
            if(kmw_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/perencanaan/penanganan/lokakarya_perencanaan/select?kmw="+kmw_id,
        ...
        kota.change(function(){
            ...
            if(kota_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/perencanaan/penanganan/lokakarya_perencanaan/select?kota_korkot="+kota_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
