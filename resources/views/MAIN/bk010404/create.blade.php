      ...
      $(document).ready(function () {
        $('#form').on('submit', function (e) {
          ...
          $.ajax({
            ...
            processData: false,
            contentType: false,
            "url": "/main/pelaksanaan/kota_bdi/sertifikasi_infra/create",
            data: form_data,
            beforeSend: function (){
        ...
        parent.change(function(){
            ...
            if(parent_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/pelaksanaan/kota_bdi/sertifikasi_infra/select?kode_parent_tahun="+parent_id,
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/pelaksanaan/kota_bdi/sertifikasi_infra/select?kode_parent_kmw="+parent_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/pelaksanaan/kota_bdi/sertifikasi_infra/select?kode_parent_kota="+parent_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/pelaksanaan/kota_bdi/sertifikasi_infra/select?kode_parent_korkot="+parent_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/pelaksanaan/kota_bdi/sertifikasi_infra/select?kode_parent_kawasan="+parent_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
