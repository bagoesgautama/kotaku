        ...
        <div class="panel filterable">
            <div class="panel-heading clearfix  ">
                <div class="panel-title pull-left">
                    <b>Realisasi Kegiatan</b>
                </div>
                @if( ! empty($detil['506']))
                <div class="tools pull-right">
                    <b>bk010401 index</b>
                    <a class="button button-glow button-rounded button-primary-flat hvr-float-shadow" href="{{'/main/pelaksanaan/kota_bdi/realisasi_kegiatan/create'}}">Create</a>
                </div>
                @endif
            </div>
...
<script>
    $(document).ready(function () {
        var table = $('#pokja').DataTable({
            ...
            "serverSide": true,
            "ajax":{
                     "url": "/main/pelaksanaan/kota_bdi/realisasi_kegiatan",
                     "dataType": "json",
                     "type": "POST"
                   },
