                    ...
                    <div class="col-md-12">
                        <form enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="example-text-input2">Prop</label>          
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select id="select-kode_kawasan-input" class="form-control select2" name="select-kode_kawasan-input-input">
                                        @foreach($kode_kawasan_list as $list)
                                            <option value="{{ $list->kode }}" @if($list->kode==$kode_kawasan) selected="selected" @endif >{{ $list->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group striped-col">
                                <label class="col-sm-3 control-label" for="example-textarea-input2">Topologi Pemukiman</label>
                                <div class="col-sm-6">
                                    <textarea id="topologi_pmkm-input" name="topologi_pmkm-input" rows="7" class="form-control resize_vertical" placeholder="Topologi Pemukiman" maxlength="100">{{ $topologi_pmkm }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="example-textarea-input2">Karakter Kawasan</label>
                                <div class="col-sm-6">
                                    <textarea id="karakter_kaw-input" name="karakter_kaw-input" rows="7" class="form-control resize_vertical" placeholder="Karakter Kawasan" maxlength="100">{{ $karakter_kaw }}</textarea>
                                </div>
                            </div>
                            <div class="form-group striped-col">
                                <label class="col-sm-3 control-label" for="example-textarea-input2">Pola Penanganan</label>
                                <div class="col-sm-6">
                                    <textarea id="pola_penanganan-input" name="pola_penanganan-input" rows="7" class="form-control resize_vertical" placeholder="Topologi Pemukiman" maxlength="100">{{ $pola_penanganan }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Status Lahan</label>
                                <div class="col-sm-6">
                                    <input type="text" id="status_lahan-input" name="status_lahan-input" class="form-control" placeholder="Status Lahan" value="{{$status_lahan}}" maxlength="5">
                                </div>
                            </div>
                            <div class="form-group striped-col">
                                <label class="col-sm-3 control-label">Status Hunian</label>
                                <div class="col-sm-6">
                                    <input type="text" id="status_hunian-input" name="status_hunian-input" class="form-control" placeholder="Status Hunian" value="{{$status_hunian}}" maxlength="5">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Kepadatan Bangunan</label>
                                <div class="col-sm-6">
                                    <input type="number" id="q_peserta_miskin-input" name="q_peserta_miskin-input" class="form-control" placeholder="Peserta Miskin" value="{{$q_peserta_miskin}}" maxlength="12">
                                </div>
                            </div>
                            <div class="form-group striped-col">
                                <label class="col-sm-3 control-label">Jumlah Penduduk</label>
                                <div class="col-sm-6">
                                    <input type="number" id="pdk_q_jiwa-input" name="pdk_q_jiwa-input" class="form-control" placeholder="Jiwa" value="{{$pdk_q_jiwa}}" maxlength="11">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Jumlah Penduduk Perempuan</label>
                                <div class="col-sm-6">
                                    <input type="number" id="pdk_q_jiwa_w-input" name="pdk_q_jiwa_w-input" class="form-control" placeholder="Jiwa" value="{{$pdk_q_jiwa_w}}" maxlength="11">
                                </div>
                            </div>
                            <div class="form-group striped-col">
                                <label class="col-sm-3 control-label">Jumlah Penduduk MBR</label>
                                <div class="col-sm-6">
                                    <input type="number" id="pdk_q_mbr-input" name="pdk_q_mbr-input" class="form-control" placeholder="Jiwa" value="{{$pdk_q_mbr}}" maxlength="11">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Jumlah Kepala Keluarga</label>
                                <div class="col-sm-6">
                                    <input type="number" id="pdk_q_kk-input" name="pdk_q_kk-input" class="form-control" placeholder="Kepala Keluarga" value="{{$pdk_q_kk}}" maxlength="9">
                                </div>
                            </div>
                            <div class="form-group striped-col">
                                <label class="col-sm-3 control-label">Jumlah Kepala Keluarga Miskin</label>
                                <div class="col-sm-6">
                                    <input type="number" id="pdk_q_kk_miskin-input" name="pdk_q_kk_miskin-input" class="form-control" placeholder="Kepala Keluarga Miskin" value="{{$pdk_q_kk_miskin}}" maxlength="9">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Kepadatan Penduduk</label>
                                <div class="col-sm-6">
                                    <input type="number" id="pdk_kpdt_pddk-input" name="pdk_kpdt_pddk-input" class="form-control" placeholder="Jiwa/Ha" value="{{$pdk_kpdt_pddk}}" maxlength="12">
                                </div>
                            </div>
                            <div class="form-group striped-col">
