        ...
        <ul class="breadcrumb">
            ...
            <li class="next">
                <a href="/main/perencanaan/kelurahan/investasi_5thn">
                    Perencanaan / Rencana Kelurahan / Rencana Investasi Tahunan
                </a>
            </li>
            <li class="next">
                Create
                ...
                <div class="tab-content">
                    ...
                    <div class="form-group form-actions">
                        <div class="col-sm-9 col-sm-offset-3">
                            <a href="/main/perencanaan/kelurahan/investasi_5thn" type="button" class="btn btn-effect-ripple btn-danger">
                                Cancel
                            </a>
      ...
      $(document).ready(function () {
        ...
        $('#form').on('submit', function (e) {
          ...
          $.ajax({
            ...
            processData: false,
            contentType: false,
            "url": "/main/perencanaan/kelurahan/investasi_5thn/create",
            data: form_data,
            beforeSend: function (){
        ...
        kmw.change(function(){
            ...
            if(kmw_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/perencanaan/kelurahan/investasi_5thn/select?kmw="+kmw_id,
        ...
        kota.change(function(){
            ...
            if(kota_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/perencanaan/kelurahan/investasi_5thn/select?kota_korkot="+kota_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
        ...
        kota.change(function(){
            ...
            if(kota_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/perencanaan/kelurahan/investasi_5thn/select?kota_kec="+kota_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
        ...
        kec.change(function(){
            ...
            if(kec_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/perencanaan/kelurahan/investasi_5thn/select?kec_kel="+kec_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
        ...
        kel.change(function(){
            ...
            if(kel_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/perencanaan/kelurahan/investasi_5thn/select?kel_faskel="+kel_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
        ...
        subkomponen.change(function(){
            ...
            if(subkomponen_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/perencanaan/kelurahan/investasi_5thn/select?id_subkomponen="+subkomponen_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
