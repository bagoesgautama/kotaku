        ...
        <ul class="breadcrumb">
            ...
            <li class="next">
                <a href="/main/persiapan/kelurahan/pemilu_bkm/persiapan">
                    Persiapan Kelurahan / Pemilihan Ulang BKM/LKM / Persiapan Pemilu BKM/LKM
                </a>
            </li>
            <li class="next">
                Create
                    ...
                    <div class="col-md-12">
                        <form id="form-validation" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" id="tgl_kegiatan-input" name="tgl_kegiatan-input" placeholder="Tanggal Kegiatan" data-provide="datepicker" data-date-format="yyyy-mm-dd" value="{{$tgl_kegiatan}}" data-bv-callback="true" data-bv-callback-message="Tanggal melebihi current date." data-bv-callback-callback="tgl">
                                </div>
                            </div>
                            <div class="form-group striped-col">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <br>
                                    <img id="uri_img_document" alt="gallery" src="/uploads/persiapan/kelurahan/pemilu_bkm/persiapan/{{$uri_img_document}}" {!! $uri_img_document==null ? 'style="display:none"':'style="width:150px"' !!} >
                            ...
                            <div class="form-group striped-col">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <br>
                                    <img id="uri_img_absensi" alt="gallery" src="/uploads/persiapan/kelurahan/pemilu_bkm/persiapan/{{$uri_img_absensi}}" {!! $uri_img_absensi==null ? 'style="display:none"':'style="width:150px"' !!} >
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-9 col-sm-offset-3">
                                    <a href="/main/persiapan/kelurahan/pemilu_bkm/persiapan" type="button" class="btn btn-effect-ripple btn-danger">
                                        Cancel
                                    </a>
                                    @if ($detil_menu=='580' || $detil_menu=='581')
    ...
    $(document).ready(function () {
        ...
        $('#form-validation').bootstrapValidator().on('success.form.bv', function(e) {
            $('#form-validation').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    processData: false,
                    contentType: false,
                    "url": "/main/persiapan/kelurahan/pemilu_bkm/persiapan/create",
                    data: form_data,
                    beforeSend: function (){
                    ...
                    success: function () {
                        ...
                        window.location.href = "/main/persiapan/kelurahan/pemilu_bkm/persiapan";
                    },
        ...
        kota.change(function(){
            ...
            if(kota_id!=undefined){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/pemilu_bkm/persiapan/select?kec="+kota_id+"&faskel="+faskel_id,
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/pemilu_bkm/persiapan/select?korkot="+kota_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
        ...
        kecamatan.change(function(){
            ...
            if(kec_id!=undefined){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/pemilu_bkm/persiapan/select?kel="+kec_id+"&faskel="+faskel_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
        ...
        kelurahan.change(function(){
            ...
            if(kel_id!=undefined){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/pemilu_bkm/persiapan/select?faskel="+kel_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
