@extends('MAIN/default') {{-- Page title --}} @section('title') Kegiatan Kelurahan Form @stop {{-- local styles --}} @section('header_styles')
        ...
        <ul class="breadcrumb">
			...
			<li class="next">
				<a href="/main/data_master/keg_kelurahan">
	                Master Data / Data Master / Kegiatan Kelurahan
				</a>
            </li>
            <li class="next">
                Create
                        ...
                        <form id="form" enctype="multipart/form-data" class="form-horizontal form-bordered">
							<div class="form-group striped-col">
				                ...
				                <div class="col-sm-6">
				                    ...
				                    <input type="text" id="kode_kegiatan-input" name="kode_kegiatan-input" class="form-control" placeholder="Kode Kegiatan" value="{{$kode_kegiatan}}" required>
				                </div>
				            </div>
							...
							<div class="form-group striped-col">
				                ...
				                <div class="col-sm-6">
				                    <input type="text" id="keterangan-input" name="keterangan-input" class="form-control" placeholder="keterangan" value="{{$keterangan}}" required>
				                </div>
				            </div>
							<div class="form-group">
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-9 col-sm-offset-3">
                                    <a href="/main/data_master/keg_kelurahan" type="button" class="btn btn-effect-ripple btn-danger">
                                        Cancel
                                    </a>
...
<script>
      $(document).ready(function () {
        $('#form').on('submit', function (e) {
          ...
          $.ajax({
            type: 'post',
            "url": "/main/data_master/keg_kelurahan/create",
            data: $('form').serialize(),
            beforeSend: function (){
            ...
            window.location.href = "/main/data_master/keg_kelurahan";
            },
