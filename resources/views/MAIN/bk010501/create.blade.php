                ...
                <div class="tab-content">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select id="select-kode-parent-input" name="kode-parent-input" class="form-control select2" size="1" required>
                                                ...
                                                @foreach ($kode_parent_list as $kpl)
                                                    <option value="{{$kpl->kode}}" {!! $kode==$kpl->kode ? 'selected':'' !!}>{{$kpl->jenis_komponen_keg.$kpl->usulan_komponen.'-'.$kpl->nama_subkomponen.'-'.$kpl->nama_dtl_subkomponen}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="form-group form-actions">
                        <div class="col-sm-9 col-sm-offset-3">
                            <a href="/main/keberlanjutan/kota/serah_terima" type="button" class="btn btn-effect-ripple btn-danger">
                                Cancel
                            </a>
      ...
      $(document).ready(function () {
        ...
        $('#form').on('submit', function (e) {
          ...
          $.ajax({
            ...
            processData: false,
            contentType: false,
            "url": "/main/keberlanjutan/kota/serah_terima/create",
            data: form_data,
            beforeSend: function (){
            ...
            window.location.href = "/main/keberlanjutan/kota/serah_terima";
            },
        ...
        parent.change(function(){
            ...
            if(parent_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/keberlanjutan/kota/serah_terima/select?kode_parent="+parent_id,
