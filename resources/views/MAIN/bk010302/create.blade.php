@extends('MAIN/default') {{-- Page title --}} @section('title') Pelaksanaan RPK Form @stop {{-- local styles --}} @section('header_styles')
                        ...
                        <form id="form" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-9 col-sm-offset-3">
                                    ...
                                    @if ($detil_menu=='259' || $detil_menu=='260')
      ...
      $(document).ready(function () {
        ...
        $('#form').on('submit', function (e) {
          ...
          $.ajax({
            ...
            processData: false,
            contentType: false,
            "url": "/main/perencanaan/penanganan/pelaksanaan_rpk/create",
            data: form_data,
            beforeSend: function (){
            ...
            window.location.href = "/main/perencanaan/penanganan/pelaksanaan_rpk";
            },
        ...
        kmw.change(function(){
            ...
            if(kmw_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/perencanaan/penanganan/pelaksanaan_rpk/select?kmw="+kmw_id,
        ...
        kota.change(function(){
            ...
            if(kota_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/perencanaan/penanganan/pelaksanaan_rpk/select?kota_korkot="+kota_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
