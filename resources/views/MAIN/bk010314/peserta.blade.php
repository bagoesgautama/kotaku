        ...
        <div class="panel filterable">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    ...
                    <input type="hidden" id="kode_lelang" name="kode_lelang" value="{{ $kode_lelang }}">
                    ...
                    <div class="form-group form-actions">
                        <div class="col-sm-9 col-sm-offset-3">
                            <a href="/main/perencanaan/pengadaan_lelang/create?kode={{$kode_lelang}}" type="button" class="btn btn-effect-ripple btn-danger">
                                Cancel
                            </a>
...
<script>
      $(document).ready(function () {
        $('.ui-pnotify').remove();
        var kode_lelang = $('#kode_lelang').val();
        var where = $('#where').val();
        var table = $('#peserta').DataTable({
            ...
            "ajax":{
                     ...
                     "data":{kode_lelang : kode_lelang, where : where},
                     "dataType": "json",
                     "type": "POST"
                   },
        ...
        $('#peserta_filter input').unbind();
        $('#peserta_filter input').bind('keyup', function(e) {
            if(e.keyCode == 13) {
        ...
        $('#form').on('submit', function (e) {
          ...
          $.ajax({
            ...
            window.location.href = "/main/perencanaan/pengadaan_lelang/create?kode="+kode_lelang;
            },
