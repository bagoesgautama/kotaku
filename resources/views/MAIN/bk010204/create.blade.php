                    ...
                    <div class="col-md-12">
                        <form id="form" enctype="multipart/form-data" class="form-horizontal form-bordered">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" id="q_non_anggota-input" name="q_non_anggota-input" class="form-control" placeholder="Jumlah" value="{{$q_non_anggota}}" maxlength="11" min="0" required>
                                </div>
                            </div>
                            <div class="form-group striped-col">
