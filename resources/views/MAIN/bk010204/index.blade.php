@extends('MAIN/default') {{-- Page title --}} @section('title') Main - Kegaitan/Monitoring POKJA @stop {{-- local styles --}} @section('header_styles')
        ...
        <div class="panel filterable">
            <div class="panel-heading clearfix  ">
                ...
                <div class="tools pull-right">
                    <b>bk010204 index</b>
                    <a class="button button-glow button-rounded button-primary-flat hvr-float-shadow" href="{{ '/main/persiapan/propinsi/pokja/kegiatan/create' }}">Create</a>
                </div>
                @endif
            </div>
...
<script>
    $(document).ready(function () {
        var table = $('#kegiatan').DataTable({
            ...
            "serverSide": true,
            "ajax":{
                     "url": "/main/persiapan/propinsi/pokja/kegiatan",
                     "dataType": "json",
                     "type": "POST"
                   },
            "columns": [
