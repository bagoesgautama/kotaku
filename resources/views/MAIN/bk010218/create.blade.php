                    ...
                    <div class="col-md-12">
                        <form id="form-validation" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" id="tgl-kegiatan-input" name="tgl-kegiatan-input" placeholder="Tanggal Pendataan" data-provide="datepicker" data-date-format="yyyy-mm-dd" value="{{$tgl_kegiatan}}" required data-bv-callback="true" data-bv-callback-message="Tanggal melebihi current date." data-bv-callback-callback="tgl">
                                </div>
                            </div>
                            <div class="form-group striped-col">
                                <label class="col-sm-3 control-label" for="kode">Anggota Laki-laki</label>
                                <div class="col-sm-6">
                                    <input type="number" id="q-laki-input" name="q-laki-input" class="form-control" placeholder="Jumlah" value="{{$q_peserta_p}}" maxlength="5" data-bv-callback="true" data-bv-callback-message="Jumlah melebihi total anggota laki-laki & perempuan" data-bv-callback-callback="check" min="0" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="kode">Anggota Perempuan</label>
                                <div class="col-sm-6">
                                    <input type="number" id="q-perempuan-input" name="q-perempuan-input" class="form-control" placeholder="Jumlah" value="{{$q_peserta_w}}" maxlength="5" data-bv-callback="true" data-bv-callback-message="Jumlah melebihi total anggota laki-laki & perempuan" data-bv-callback-callback="check" min="0" required>
                                </div>
                            </div>
                            <div class="form-group striped-col">
                                <label class="col-sm-3 control-label" for="kode">Anggota Miskin/MBR</label>
                                <div class="col-sm-6">
                                    <input type="number" id="q-mbr-input" name="q-mbr-input" class="form-control" placeholder="Jumlah" value="{{$q_peserta_mbr}}" maxlength="5" data-bv-callback="true" data-bv-callback-message="Jumlah melebihi total anggota laki-laki & perempuan" data-bv-callback-callback="check" min="0" required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-9 col-sm-offset-3">
                                    ...
                                    @if ($detil_menu=='195' || $detil_menu=='196')
    ...
    $(document).ready(function () {
        ...
        $('#form-validation').bootstrapValidator().on('success.form.bv', function(e) {
            $('#form-validation').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    processData: false,
                    contentType: false,
                    "url": "/main/persiapan/kelurahan/agen_sosialisasi/create",
                    data: form_data,
                    beforeSend: function (){
                    ...
                    success: function () {
                        ...
                        window.location.href = "/main/persiapan/kelurahan/agen_sosialisasi";
                    },
        ...
        kota.change(function(){
            ...
            if(kota_id!=undefined){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/agen_sosialisasi/select?kec="+kota_id+"&faskel="+faskel_id,
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/agen_sosialisasi/select?korkot="+kota_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
        ...
        kecamatan.change(function(){
            ...
            if(kec_id!=undefined){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/agen_sosialisasi/select?kel="+kec_id+"&faskel="+faskel_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
        ...
        kelurahan.change(function(){
            ...
            if(kel_id!=undefined){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/agen_sosialisasi/select?faskel="+kel_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
