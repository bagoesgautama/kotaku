                        ...
                        <form id="form" enctype="multipart/form-data" class="form-horizontal form-bordered">
							<div class="form-group striped-col">
				                ...
				                <div class="col-sm-6">
				                    ...
				                    <input type="text" id="kode_unsur-input" name="kode_unsur-input" class="form-control" placeholder="Kode " value="{{$kode_unsur}}" required>
				                </div>
				            </div>
							...
							<div class="form-group striped-col">
				                ...
				                <div class="col-sm-6">
				                    <textarea id="keterangan-input" name="keterangan-input" class="form-control" placeholder=""  required>{{$keterangan}}</textarea>
				                </div>
				            </div>
							<div class="form-group ">
