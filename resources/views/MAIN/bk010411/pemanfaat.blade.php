...
<section class="content-header">
    ...
    <div class="bs-example">
        <ul class="breadcrumb">
            ...
            <li class="next">
                <a href="/main/pelaksanaan/kelurahan_non/realisasi_kegiatan/create?kode={{$kode_real_keg}}">
                    Pelaksanaan / Realisasi Kegiatan Skala Kelurahan BDI Kolaborasi / Create
                </a>
            </li>
            <li class="next">
                Penerima Manfaat
                ...
                <div class="table-responsive">
                    ...
                    <div class="form-group form-actions">
                        <div class="col-sm-9 col-sm-offset-3">
                            <a href="/main/pelaksanaan/kelurahan_non/realisasi_kegiatan/create?kode={{$kode_real_keg}}" type="button" class="btn btn-effect-ripple btn-danger">
                                Cancel
                            </a>
      ...
      $(document).ready(function () {
        ...
        $('#form').on('submit', function (e) {
          ...
          $.ajax({
            ...
            processData: false,
            contentType: false,
            "url": "/main/pelaksanaan/kelurahan_non/realisasi_kegiatan/pemanfaat/create",
            data: form_data,
            beforeSend: function (){
            ...
            window.location.href = "/main/pelaksanaan/kelurahan_non/realisasi_kegiatan/create?kode="+kode_real_keg;
            },
