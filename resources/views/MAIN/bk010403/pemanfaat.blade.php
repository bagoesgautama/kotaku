        ...
        <div class="panel filterable">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    ...
                    <input type="hidden" id="kode_real_ktrk" name="kode_real_ktrk" value="{{ $kode_real_ktrk }}">
                    ...
                    <div class="form-group form-actions">
                        <div class="col-sm-9 col-sm-offset-3">
                            <a href="/main/pelaksanaan/kota_bdi/realisasi_kontrak/create?kode={{$kode_real_ktrk}}" type="button" class="btn btn-effect-ripple btn-danger">
                                Cancel
                            </a>
