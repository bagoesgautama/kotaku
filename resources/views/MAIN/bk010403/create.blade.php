        ...
        <ul class="breadcrumb">
            ...
            <li class="next">
                <a href="/main/pelaksanaan/kota_bdi/realisasi_kontrak">
                    Pelaksanaan / Realisasi Kegiatan Skala Kota (Non BDI Kolaborasi) / Realisasi Kontrak Paket Pekerjaan dari Kontraktor
                </a>
            </li>
            <li class="next">
                Create
                ...
                <div class="tab-content">
                            ...
                            <div class="panel-body border">
                                <div class="row">
                                    <div class="form-group striped-col">
                                        <label class="col-sm-3 control-label">Data Kontrak Paket Pekerjaan Kontraktor</label>
                                        <div class="col-sm-6">
                                            ...
                                            <select id="select-kode-parent-input" name="kode-parent-input" class="form-control select2" size="1" required>
                                                ...
                                                @foreach ($kode_parent_list as $kpl)
                                                    <option value="{{$kpl->kode}}" {!! $kode_parent==$kpl->kode ? 'selected':'' !!}>{{$kpl->jenis_komponen_keg.'-'.$kpl->nama_subkomponen.'-'.$kpl->nama_dtl_subkomponen.'-'.$kpl->nama_kota}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="form-group form-actions">
                        <div class="col-sm-9 col-sm-offset-3">
                            <a href="/main/pelaksanaan/kota_bdi/realisasi_kontrak" type="button" class="btn btn-effect-ripple btn-danger">
                                Cancel
                            </a>
      ...
      $(document).ready(function () {
        ...
        $('#form').on('submit', function (e) {
          ...
          $.ajax({
            ...
            processData: false,
            contentType: false,
            "url": "/main/pelaksanaan/kota_bdi/realisasi_kontrak/create",
            data: form_data,
            beforeSend: function (){
        ...
        parent.change(function(){
            ...
            if(parent_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/pelaksanaan/kota_bdi/realisasi_kontrak/select?kode_parent_tahun="+parent_id,
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/pelaksanaan/kota_bdi/realisasi_kontrak/select?kode_parent_kmw="+parent_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/pelaksanaan/kota_bdi/realisasi_kontrak/select?kode_parent_kota="+parent_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/pelaksanaan/kota_bdi/realisasi_kontrak/select?kode_parent_korkot="+parent_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/pelaksanaan/kota_bdi/realisasi_kontrak/select?kode_parent_kawasan="+parent_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
