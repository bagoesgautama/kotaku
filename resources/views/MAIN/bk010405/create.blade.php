        ...
        <ul class="breadcrumb">
            ...
            <li class="next">
                <a href="/main/pelaksanaan/kota_non/realisasi_kegiatan">
                    Pelaksanaan / Realisasi Kegiatan Skala Kota (Non BDI Kolaborasi) / Realisasi Kegiatan Skala Kota
                </a>
            </li>
            <li class="next">
                Create
      ...
      $(document).ready(function () {
        ...
        $('#form').on('submit', function (e) {
          ...
          $.ajax({
            ...
            processData: false,
            contentType: false,
            "url": "/main/pelaksanaan/kota_non/realisasi_kegiatan/create",
            data: form_data,
            beforeSend: function (){
        ...
        kmw.change(function(){
            ...
            if(kmw_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/pelaksanaan/kota_non/realisasi_kegiatan/select?kmw="+kmw_id,
        ...
        kota.change(function(){
            ...
            if(kota_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/pelaksanaan/kota_non/realisasi_kegiatan/select?kota_korkot="+kota_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
        ...
        kota.change(function(){
            ...
            if(kota_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/pelaksanaan/kota_non/realisasi_kegiatan/select?kota_kawasan="+kota_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
