@extends('MAIN/default') {{-- Page title --}} @section('title') Persiapan Kelurahan - KSM Ekonomi - KSM Syariah @stop {{-- local styles --}}
...
<section class="content-header">
    <h1>Persiapan Kelurahan - KSM Ekonomi - KSM Syariah</h1>
                        ...
                        <form enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-9 col-sm-offset-3">
                                    <a href="/main/persiapan/kelurahan/lembaga/ksm/syariah" type="button" class="btn btn-effect-ripple btn-danger">
                                        Cancel
                                    </a>
...
<script>
      $(document).ready(function () {
        ...
        $.ajax({
            type: 'post',
            "url": "/main/persiapan/kelurahan/lembaga/ksm/syariah/create",
            data: $('form').serialize(),
            beforeSend: function (){
            ...
            window.location.href = "/main/persiapan/kelurahan/lembaga/ksm/syariah";
            },
