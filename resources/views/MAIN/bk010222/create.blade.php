                ...
                <div class="row">
                    <div class="col-md-12">
                        <form enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group striped-col">
                                <label class="col-sm-3 control-label">Peserta MBR</label>
                                <div class="col-sm-6">
                                    <input type="text" id="q_peserta_mbr-input" name="q_peserta_mbr-input" class="form-control" placeholder="Peserta MBR" value="{{$q_peserta_mbr}}" maxlength="5">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Utusan Pria</label>
                                <div class="col-sm-6">
                                    <input type="text" id="q_utusan_p-input" name="q_utusan_p-input" class="form-control" placeholder="Utusan Pria" value="{{$q_utusan_p}}" maxlength="5">
                                </div>
                            </div>
                            <div class="form-group striped-col">
                                <label class="col-sm-3 control-label">Utusan Wanita</label>
                                <div class="col-sm-6">
                                    <input type="text" id="q_utusan_w-input" name="q_utusan_w-input" class="form-control" placeholder="Utusan Wanita" value="{{$q_utusan_w}}" maxlength="5">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Terpilih Pria</label>
                                <div class="col-sm-6">
                                    <input type="text" id="q_terpilih_p-input" name="q_terpilih_p-input" class="form-control" placeholder="Terpilih Pria" value="{{$q_terpilih_p}}" maxlength="5">
                                </div>
                            </div>
                            <div class="form-group striped-col">
                                <label class="col-sm-3 control-label">Terpilih Wanita</label>
                                <div class="col-sm-6">
                                    <input type="text" id="q_terpilih_w-input" name="q_terpilih_w-input" class="form-control" placeholder="Terpilih Wanita" value="{{$q_terpilih_w}}" maxlength="5">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Terpilih MBR</label>
                                <div class="col-sm-6">
                                    <input type="text" id="q_terpilih_mbr-input" name="q_terpilih_mbr-input" class="form-control" placeholder="Terpilih MBR" value="{{$q_terpilih_mbr}}" maxlength="5">
                                </div>
                            </div>
                            <div class="form-group striped-col">
...
<script>
      $(document).ready(function () {
        $('#submit').on('click', function (e) {
            ...
            form_data.append('q_peserta_mbr-input', $('#q_peserta_mbr-input').val());
            form_data.append('q_utusan_p-input', $('#q_utusan_p-input').val());
            form_data.append('q_utusan_w-input', $('#q_utusan_w-input').val());
            form_data.append('q_terpilih_p-input', $('#q_terpilih_p-input').val());
            form_data.append('q_terpilih_w-input', $('#q_terpilih_w-input').val());
            form_data.append('q_terpilih_mbr-input', $('#q_terpilih_mbr-input').val());
        ...
        if(kode_kmw!=null){
            ...
            $.ajax({
                type: 'get',
                "url": "/main/persiapan/kelurahan/pemilu_bkm/select?kmw="+kode_prop,
            ...
            $.ajax({
                type: 'get',
                "url": "/main/persiapan/kelurahan/pemilu_bkm/select?kota="+kode_kota,
                success: function (data) {
                    data=JSON.parse(data)
                    for (var i=0;i<data.length;i++){
            ...
            $.ajax({
                type: 'get',
                "url": "/main/persiapan/kelurahan/pemilu_bkm/select?korkot="+kode_korkot,
                success: function (data) {
                    data=JSON.parse(data)
                    for (var i=0;i<data.length;i++){
            ...
            $.ajax({
                type: 'get',
                "url": "/main/persiapan/kelurahan/pemilu_bkm/select?kecamatan="+kode_kec,
                success: function (data) {
                    data=JSON.parse(data)
                    for (var i=0;i<data.length;i++){
            ...
            $.ajax({
                type: 'get',
                "url": "/main/persiapan/kelurahan/pemilu_bkm/select?kelurahan="+kode_kel,
                success: function (data) {
                    data=JSON.parse(data)
                    for (var i=0;i<data.length;i++){
        ...
        kelurahan.change(function(){
            ...
            if(kel_id!=undefined){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/pemilu_bkm/select?kel="+kel_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
                            faskel.append("<option value="+data[i].kode+" >"+data[i].nama+"</option>");
