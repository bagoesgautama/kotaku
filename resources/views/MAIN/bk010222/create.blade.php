                            ...
                            <div class="form-group striped-col">
                                ...
                                <div class="col-sm-6">
                                    <select id="select-jenis_kegiatan-input" name="select-jenis_kegiatan-input" class="form-control" size="1">
                                        <option value="">Please Select</option>
                                        <option value="2.6.2.1" @if($jenis_kegiatan=="2.6.2.1") selected="selected" @endif >Seleksi Tingkat Basis</option>
                                        <option value="2.6.2.2" @if($jenis_kegiatan=="2.6.2.2") selected="selected" @endif >Seleksi Tingkat Kelurahan</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
