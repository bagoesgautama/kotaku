@extends('MAIN/default') {{-- Page title --}} @section('title') Kegiatan Pelatihan Form @stop {{-- local styles --}} @section('header_styles')
                        ...
                        <form enctype="multipart/form-data" class="form-horizontal form-bordered signup_validator" >
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-9 col-sm-offset-3">
                                    <a href="/main/data_master/keg_pelatihan" type="button" class="btn btn-effect-ripple btn-danger">
                                        Cancel
                                    </a>
...
<script>
      $(document).ready(function () {
        $('#submit').on('click', function (e) {
          ...
          $.ajax({
            type: 'post',
            "url": "/main/data_master/keg_pelatihan/create",
            data: $('form').serialize(),
            beforeSend: function (){
            ...
            window.location.href = "/main/data_master/keg_pelatihan";
            },
