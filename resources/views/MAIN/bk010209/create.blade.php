                        ...
                        <form id="form-validation" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <br>
                                    <img id="uri_img_document" alt="gallery" src="/uploads/persiapan/kota/forum/bkm/{{$uri_img_document}}" {!! $uri_img_document==null ? 'style="display:none"':'style="width:150px"' !!} >
                            ...
                            <div class="form-group striped-col">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <br>
                                    <img id="uri_img_absensi" alt="gallery" src="/uploads/persiapan/kota/forum/bkm/{{$uri_img_absensi}}" {!! $uri_img_absensi==null ? 'style="display:none"':'style="width:150px"' !!} >
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-9 col-sm-offset-3">
									...
									@if ($detil_menu=='154' || $detil_menu=='155')
