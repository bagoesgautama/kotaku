@extends('MAIN/default') {{-- Page title --}} @section('title') Pelaksanaan - Realisasi Kegiatan Skala Kelurahan Non BDI Kolaborasi - Sertifikasi Infrastruktur @stop {{-- local styles --}} @section('header_styles')
...
<section class="content-header">
    <h1>Pelaksanaan - Realisasi Kegiatan Skala Kelurahan Non BDI Kolaborasi - Sertifikasi Infrastruktur</h1>
        ...
        <ul class="breadcrumb">
            ...
            <li class="next">
                <a href="/main/pelaksanaan/kelurahan_non/sertifikasi_infra">
                    Pelaksanaan / Realisasi Kegiatan Skala Kelurahan Non BDI Kolaborasi / Sertifikasi Infrastruktur
                </a>
            </li>
            <li class="next">
                <a>
                ...
                <div class="tab-content">
                    ...
                    <div class="form-group form-actions">
                        <div class="col-sm-9 col-sm-offset-3">
                            <a href="/main/pelaksanaan/kelurahan_non/sertifikasi_infra" type="button" class="btn btn-effect-ripple btn-danger">
                                Cancel
                            </a>
      ...
      $(document).ready(function () {
        ...
        $('#form').on('submit', function (e) {
          ...
          $.ajax({
            ...
            processData: false,
            contentType: false,
            "url": "/main/pelaksanaan/kelurahan_non/sertifikasi_infra/create",
            data: form_data,
            beforeSend: function (){
            ...
            window.location.href = "/main/pelaksanaan/kelurahan_non/sertifikasi_infra";
            },
