                        ...
                        <form id="form-validation" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <br>
                                    <img id="uri_img_document" alt="gallery" src="/uploads/persiapan/kecamatan/forum/kolaborasi/{{$uri_img_document}}" {!! $uri_img_document==null ? 'style="display:none"':'style="width:150px"' !!} >
                            ...
                            <div class="form-group striped-col">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <br>
                                    <img id="uri_img_absensi" alt="gallery" src="/uploads/persiapan/kecamatan/forum/kolaborasi/{{$uri_img_absensi}}" {!! $uri_img_absensi==null ? 'style="display:none"':'style="width:150px"' !!} >
