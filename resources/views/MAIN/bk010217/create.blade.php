                        ...
                        <form id="form-validation" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="hidden" id="jenis_kegiatan-input" name="jenis_kegiatan-input" value="2.5.1.4">
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-9 col-sm-offset-3">
                                    ...
                                    @if ($detil_menu=='191' || $detil_menu=='192')
    ...
    $(document).ready(function () {
        ...
        kota.change(function(){
            ...
            if(kota_id!=undefined){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/relawan/select?kec="+kota_id+"&faskel="+faskel_id,
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/relawan/select?korkot="+kota_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
        ...
        kecamatan.change(function(){
            ...
            if(kec_id!=undefined){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/relawan/select?kel="+kec_id+"&faskel="+faskel_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
        ...
        kelurahan.change(function(){
            ...
            if(kel_id!=undefined){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/persiapan/kelurahan/relawan/select?faskel="+kel_id,
                    success: function (data) {
                        data=JSON.parse(data)
                        for (var i=0;i<data.length;i++){
