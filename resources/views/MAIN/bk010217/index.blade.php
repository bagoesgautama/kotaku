        ...
        <div class="panel filterable">
            <div class="panel-heading clearfix  ">
                ...
                <div class="tools pull-right">
                    <a class="button button-glow button-rounded button-primary-flat hvr-float-shadow" href="{{ '/main/persiapan/kelurahan/relawan/create' }}">Create</a>
                </div>
                @endif
            </div>
...
<script>
    $(document).ready(function () {
        var table = $('#kegiatan').DataTable({
            ...
            "serverSide": true,
            "ajax":{
                     "url": "/main/persiapan/kelurahan/relawan",
                     "dataType": "json",
                     "type": "POST"
                   },
