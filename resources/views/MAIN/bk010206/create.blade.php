                    ...
                    <div class="col-md-12">
                        <form id="form-validation" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" id="upp-opd-input" name="upp-opd-input" class="form-control" placeholder="" value="{{$upp_opd}}" data-bv-callback="true" data-bv-callback-message="Jumlah melebihi total anggota laki-laki & perempuan" data-bv-callback-callback="check" min="0">
                                </div>
                            </div>
                            <div class="form-group striped-col">
                                <label class="col-sm-3 control-label" for="kode">DPRD</label>
                                <div class="col-sm-6">
                                    <input type="number" id="upp-dprd-input" name="upp-dprd-input" class="form-control" placeholder="" value="{{$upp_dprd}}" data-bv-callback="true" data-bv-callback-message="Jumlah melebihi total anggota laki-laki & perempuan" data-bv-callback-callback="check" min="0">
                                </div>
                            </div>
							<div class="form-group">
                            ...
                            <div class="form-group striped-col">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" id="upnp-bkm-input" name="upnp-bkm-input" class="form-control" placeholder="" value="{{$upn_bkm}}" data-bv-callback="true" data-bv-callback-message="Jumlah melebihi total anggota laki-laki & perempuan" data-bv-callback-callback="check" min="0">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="kode">LSM/Pemerhati Permukiman</label>
                                <div class="col-sm-6">
                                    <input type="number" id="upnp-lsm-input" name="upnp-lsm-input" class="form-control" placeholder="" value="{{$upn_lsm}}" data-bv-callback="true" data-bv-callback-message="Jumlah melebihi total anggota laki-laki & perempuan" data-bv-callback-callback="check" min="0">
                                </div>
                            </div>
                            <div class="form-group striped-col">
                                <label class="col-sm-3 control-label" for="kode">Swasta/Badan Usaha</label>
                                <div class="col-sm-6">
                                    <input type="number" id="upnp-swasta-input" name="upnp-swasta-input" class="form-control" placeholder="" value="{{$unp_bu}}" data-bv-callback="true" data-bv-callback-message="Jumlah melebihi total anggota laki-laki & perempuan" data-bv-callback-callback="check" min="0">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="kode">Praktisi/Profesional/Perguruan Tinggi</label>
                                <div class="col-sm-6">
                                    <input type="number" id="upnp-praktisi-input" name="upnp-praktisi-input" class="form-control" placeholder="" value="{{$upn_praktisi}}" data-bv-callback="true" data-bv-callback-message="Jumlah melebihi total anggota laki-laki & perempuan" data-bv-callback-callback="check" min="0">
                                </div>
                            </div>
                            <div class="form-group striped-col">
                                <label class="col-sm-3 control-label" for="kode">Nilai Dana Operasional</label>
                                <div class="col-sm-6">
                                    <input type="number" id="dana-ops-input" name="dana-ops-input" class="form-control" placeholder="Jumlah" value="{{$nilai_dana_ops}}" data-bv-callback="true" data-bv-callback-message="Jumlah melebihi total anggota laki-laki & perempuan" data-bv-callback-callback="check" min="0">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group striped-col">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <br>
                                    <img id="url_rencana_kerja" alt="gallery" src="/uploads/persiapan/kota/pokja/pembentukan/{{$url_rencana_kerja}}" {!! $url_rencana_kerja==null ? 'style="display:none"':'style="width:150px"' !!} >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <br>
                                    <img id="uri_img_document" alt="gallery" src="/uploads/persiapan/kota/pokja/pembentukan/{{$uri_img_document}}" {!! $uri_img_document==null ? 'style="display:none"':'style="width:150px"' !!} >
                            ...
                            <div class="form-group striped-col">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <br>
                                    <img id="uri_img_absensi" alt="gallery" src="/uploads/persiapan/kota/pokja/pembentukan/{{$uri_img_absensi}}" {!! $uri_img_absensi==null ? 'style="display:none"':'style="width:150px"' !!} >
...
<script>
	function check(value, validator) {
		...
		var opd = parseInt($('#upp-opd-input').val())|| 0;
		var dprd = parseInt($('#upp-dprd-input').val())|| 0;
		var bkm = parseInt($('#upnp-bkm-input').val())|| 0;
		...
		var sum = p+w;
		var sum2 = opd+dprd+bkm+lsm+swasta+prak;
		var res = true;
		if(sum2>sum){
			res=false;
		}else if(p==0 && w==0){
