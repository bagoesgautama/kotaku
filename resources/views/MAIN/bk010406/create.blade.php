                ...
                <ul class="nav nav-tabs ">
                    <li class="active">
                        <a href="#tab1" data-toggle="tab">
                                        Data Realisasi Kegiatan (Non BDI Kolaborasi)
                                    </a>
                    </li>
                    <li>
                            ...
                            <div class="panel-body border">
                                <div class="row">
                                    <div class="form-group striped-col">
                                        <label class="col-sm-3 control-label">Data Realisasi Kegiatan (Non BDI Kolaborasi)</label>
                                        <div class="col-sm-6">
      ...
      $(document).ready(function () {
        ...
        parent.change(function(){
            ...
            if(parent_id!=null){
                ...
                $.ajax({
                    type: 'get',
                    "url": "/main/pelaksanaan/kota_non/sertifikasi_infra/select?kode_parent="+parent_id,
