@extends('QS/default') {{-- Page title --}} @section('title') Peningkatan @stop {{-- local styles --}} @section('header_styles')
...
<section class="content-header">
    ...
    <div class="bs-example">
        <ul class="breadcrumb">
			...
			<li class="next">
				<a href="/qs/monitoring/kelurahan/kelurahan?kode={{$kode_kota}}&agenda={{$agenda}}">
					{{$kota}}
				</a>
			</li>
        </ul>
						...
						<tbody>
							@foreach ($data as $i)
								<tr >
									...
									<td>{{$i->q0_peningkatan}}</td>
									<td>{{$i->q1_peningkatan}}</td>
									<td>{{$i->q2_peningkatan}}</td>
								 </tr>
							@endforeach
						</tbody>
                    </table>
