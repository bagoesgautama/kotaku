@extends('QS/default') {{-- Page title --}} @section('title') Pencegahan @stop {{-- local styles --}} @section('header_styles')
						...
						<tbody>
							@foreach ($data as $i)
								<tr >
									...
									<td>{{$i->q0_pencegahan}}</td>
									<td>{{$i->q1_pencegahan}}</td>
									<td>{{$i->q2_pencegahan}}</td>
								 </tr>
							@endforeach
						</tbody>
                    </table>
